...
def processar_lote_automatico(df, coluna_cnpj):
    ...
    for i, linha in df.iterrows():
        ...
        if not cnpj_limpo:
            ...
            # Executa a consulta automatizada integrada
            ...
            time.sleep(0.1)  # Intervalo otimizado para varredura rápida e estável
...
st.divider()
st.caption("MEI Monitor V2 — Módulo de Automação de Processos Contábeis.")import io
import re
import time
import urllib.parse
from datetime import datetime
